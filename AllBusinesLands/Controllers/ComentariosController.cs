...
namespace AllBusinesLands.Controllers
{
    public class ComentariosController : Controller
    {
        ...
        public async Task<ActionResult> Create([Bind(Include = "Id,BienId,Contenido,FechaIngreso,HoraIngreso")] Comentario comentario)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit([Bind(Include = "Id,BienId,Contenido,FechaIngreso,HoraIngreso")] Comentario comentario)
        {
            if (ModelState.IsValid)
            {
